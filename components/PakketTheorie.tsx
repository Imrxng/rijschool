    ...
    <div className="privacy-container centerContainer bg-theorie-second-white">
      ...
      <div className="pakket-theorie-card">
        <div className="pakket-theorie-header">
          ...
          <p className="pakket-theorie-subheading">
            Uitgebreide voorbereiding op je theorie-examen
          </p>
        </div>
        <div className="pakket-theorie-body">
          <p className="pakket-theorie-description">
            Dit pakket van 12 uur biedt uitgebreide theorielessen om je voor te
            bereiden op het theorie-examen.
          </p>
          <div className="pakket-theorie-details">
            <div className="pakket-theorie-item">
              <span className="pakket-theorie-label">
                Theorie lessen (in het Nederlands):
              </span>
          ...
          <div className="pakket-theorie-info">
            ...
            <p>
              De inschrijvingskosten van €25 zijn verplicht bij elk pakket en
              dekken de administratieve kosten.
            </p>
          </div>
          <Link href="/contact">
